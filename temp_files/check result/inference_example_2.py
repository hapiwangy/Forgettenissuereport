...
ADAPTER_DIR = "result_on_server/runs/outputs-trl-llama32-1b-dreaddit/adapter"  # 或改為 checkpoint-123
TOKENIZER_DIR = "result_on_server/runs/outputs-trl-llama32-1b-dreaddit"         # 用你保存好的 tokenizer
...
dfs.to_csv(r'second_result.csv')
